...
public class ConfigurationLoader
{
	...
	// Note my design decision that if the config key is missing I return null.
	// It may be more appropriate to throw an exception, because usually code that requires
	// a config value is not written to expect missing values in the config.  Throwing
	// an exception would localize the error of a missing config value to this exact location.
